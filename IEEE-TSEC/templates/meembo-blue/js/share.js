...
Share = (function(superClass) {
  ...
  Share.prototype.network_facebook = function() {
      return this.popup('https://www.facebook.com/ieeetsec',{
	   text: this.config.networks.facebook.description,
        u: this.config.networks.facebook.url
      });
  };

  Share.prototype.network_twitter = function() {
    return this.popup('https://twitter.com/ieeetsec', {
    ...
    return this.popup('http://www.linkedin.com/groups?gid=1254477&mostPopular=&trk=tyah', {
      text: this.config.networks.linkedin.description,
      url: this.config.networks.linkedin.url
    });
  };
	
  Share.prototype.network_google_plus = function() {
    return this.popup('https://plus.google.com/ieeetsec', {
      url: this.config.networks.google_plus.url
    });
  };

  Share.prototype.network_pinterest = function() {
    return this.popup('https://www.pinterest.com/ieeetsec', {
  ...
  Share.prototype.inject_html = function(instance) {
    return instance.innerHTML = "<label class='entypo-export'><span>" + this.config.ui.button_text + "</span></label><div class='social load " + this.config.ui.flyout + "'><ul><li class='entypo-pinterest' data-network='pinterest'><li class='entypo-facebook' data-network='facebook'></li></li><li class='entypo-twitter' data-network='twitter'><li class='entypo-linkedin' data-network='linkedin'></li><li class='entypo-gplus' data-network='google_plus'></li><li class='entypo-paper-plane' data-network='email'></li></ul></div>";
  };
